							...
							$.ajax({
						        ...
						        statusCode: {
					                ...
					                200: function(responseObject, textStatus, errorThrown) {
								    	...
								    	$.ajax({
								    		url: 'core/CreateEvaluacionFinalCierreTemprano.php',
								    		type: 'POST',
								    		data: "ejecutivo="+rutejecutivo,
								    		beforeSend : function() {
								    		...
								    		statusCode: {
								    			...
								    			502: function(responseObject, textStatus, errorThrown) {
								                	...
								                	$("#modalHomeContenido").html('Imposible ejecutar cierre temprano sin evaluaciones<br /><strong>HTTP 502</strong>');
								    			},
								    			...
								    			200: function(responseObject, textStatus, errorThrown) {
								    				...
								    				$("#modalHomeBtnAccion").html('Guardar Evaluación Final');
