        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" id="titleEvalPar">
                  <h6 class="m-0 font-weight-bold text-primary">Evaluaciones Parciales</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      <div class="dropdown-header">Opciones para Parciales:</div>
                      <a class="dropdown-item" href="#" id="linkEditarParciales">Editar Parciales</a>
                    </div>
                  </div>
                </div>
